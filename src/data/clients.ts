...
export const CLIENTS: ClientPage[] = [
  { slug: "levechy-x7k2", name: "株式会社LEVECHY", stage: 1, round: "調整中", amounts: { purchase: 572, barter: 230, subsidy: 346.6, net: 4.6, confirmed: true }, docsFolder: "https://drive.google.com/drive/folders/1kDCH0VilsQ2ou52VNKnVoWJzUS-p4wHM", updated: "2026-08-05" },
  ...
  { slug: "garabato-onjg", name: "株式会社Garabato Group", stage: 1, round: "調整中", amounts: { ...DEFAULT_AMOUNTS }, updated: "2026-08-05" },
];
