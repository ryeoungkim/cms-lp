...
export interface ClientPage {
  ...
  statusNote?: string;
  /** 対象申請ラウンド: 公式の締切次数（2026-08-03時点の受付中=4次〔8/25〕。5次以降は公表待ち） */
  round: "4次" | "5次" | "6次" | "調整中";
...
export const CLIENTS: ClientPage[] = [
  ...
  { slug: "leriro-q9m4", name: "LERIRO", stage: 1, round: "4次", amounts: { purchase: 572, barter: 356, subsidy: 346.6, net: 130.6, confirmed: true }, docsFolder: "https://drive.google.com/drive/folders/1pigQTG_asylMupXPED47AOLbv_Em_sd4", updated: "2026-07-16" },
  ...
  { slug: "infront-j2d6", name: "株式会社INFRONT", stage: 1, round: "4次", amounts: { purchase: 990, barter: 710, subsidy: 450, net: 170, confirmed: true }, docsFolder: "https://drive.google.com/drive/folders/1F0xEz7xp_4mJkluBICwgF_2VvLeyIhAh", updated: "2026-07-16" },
  ...
  { slug: "napoli-b6v2", name: "ナポリ", stage: 1, round: "4次", amounts: { purchase: 990, barter: 695, subsidy: 450, net: 155, confirmed: true }, docsFolder: "https://drive.google.com/drive/folders/10i5LD8J06_CVVLw3QoGlRiD3xfXn_2bc", updated: "2026-07-16" },
